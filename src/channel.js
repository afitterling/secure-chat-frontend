  ...
  return (
    <Container class="ui label" style={style}>
      ...
      <div class="ui message">
        ...
        <span><i class="lock icon"></i> <em>locked</em>: encryption on client and service's node's side.</span><br />
        <span><i class="unlock icon"></i> <em>unlocked</em>: transportation encryption only; messages can be read by everyone.</span><br />
